...
export const SECTIONS: Section[] = [
  { id: "opening", title: "Opening", startSlide: 0, color: "#94a3b8" },
  { id: "how-ai-works", title: "How Modern AI Works", startSlide: 5, color: "#60a5fa" },
...
export const SLIDES: Slide[] = [
  ...
  s(6, "The AI family tree", () => (
    <L.Body kicker="Slide Slide 7 · Source: AI Landscape p.3" title="The AI family tree">
      <AITree />
    </L.Body>
  )),

  s(8, "Four ways machines learn", () => (
    <L.Body kicker="Slide Slide 9 · Source: AI Landscape pp.5–9" title="Four ways machines learn">
  ...
  s(9, "Three places this shows up", () => (
    <L.Body kicker="Slide Slide 10 · Source: AI Landscape pp.10–13" title="Three places this shows up">
      <div className="grid md:grid-cols-3 gap-5 mt-2">
        {[
  ...
  s(10, "Closed vs open — and who's who", () => (
    <L.Body kicker="Slide Slide 11 · Source: AI Landscape p.14 + LLM History pp.19–20" title="Closed vs open — and who's who">
      <OpenClosedAccordion />
    </L.Body>
  )),

  s(11, "Neural networks", () => (
    <L.Body kicker="Slide Slide 11 · Source: LLM Theory pp.4–10" title="Neural networks">
  ...
  s(12, "Tokens — the pieces models read", () => (
    <L.Body kicker="Slide Slide 15 · Source: LLM Theory pp.12–16" title="Tokens — the pieces models read">
      <TokenSplitter />
    </L.Body>
  )),

  s(13, "Embeddings & semantic meaning", () => (
    <L.Body kicker="Slide Slide 16 · Source: LLM Theory pp.17–25" title="Embeddings &amp; semantic meaning">
      <EmbeddingSpace />
    </L.Body>
  )),

  s(14, "Vector databases & RAG", () => (
    <L.Body kicker="Slide Slide 17 · Source: LLM Field Work pp.7–18" title="Vector databases & RAG">
      <RagFlow />
    </L.Body>
  )),

  s(15, "Chunking", () => (
    <L.Body kicker="Slide Slide 18 · Source: LLM Field Work pp.16, 25" title="Chunking — the size decision that quietly matters">
      <ChunkingCompare />
    </L.Body>
  )),

  s(16, "Transformers & attention", () => (
    <L.Body kicker="Slide Slide 19 · Source: LLM Theory pp.26–35" title="Transformers &amp; attention">
      <AttentionDiagram />
  ...
  s(17, "Temperature & model choice", () => (
    <L.Body kicker="Slide Slide 20 · Source: LLM Theory pp.39–49" title="Temperature &amp; model choice">
      <TemperatureSlider />
    </L.Body>
  )),

  s(18, "Open-source vs closed-source LLMs", () => (
    <L.Body kicker="Slide Slide 21 · Source: LLM History pp.12–15" title="Open-source vs closed-source LLMs">
  ...
  s(19, "LLM strengths & weaknesses", () => (
    <L.Body kicker="Slide Slide 22 · Source: LLM Field Work pp.2–6" title="LLM strengths &amp; weaknesses">
      <div className="grid md:grid-cols-2 gap-5 mt-4">
  ...
  s(20, "AI agents, tools & OpenClaw", () => (
    <L.Body kicker="Slide Slide 23 · Source: LLM Field Work pp.28–45" title="AI agents, tools & the loop">
      <AgentLoop />
    </L.Body>
  )),

  s(21, "Claude Code — your afternoon workbench", () => (
    <L.Body kicker="Slide Slide 24 · Source: LLM Field Work pp.46–47" title="Claude Code — your afternoon workbench">
  ...
  s(22, "LLM privacy", () => (
    <L.Body kicker="Slide Slide 25 · Source: LLM Field Work pp.53–57" title="LLM privacy — three tiers">
      <PrivacyTiers />
    </L.Body>
  )),
  ...
  s(28, "The lazy brief vs the structured brief", () => (
    <L.Body kicker="Slide Slide 31 · Source: Prompt Planning Sheet + Building a Prompt" title="The lazy brief vs the structured brief">
      <div className="grid md:grid-cols-2 gap-5 mt-4">
...
- If a figure isn't in the source, say "not stated" rather than estimate.`}
  ...
  s(33, "The assembled prompt & three takeaways", () => (
    <L.Body kicker="Slide Slide 36 · Source: Prompt Planning Sheet (full framework)" title="The assembled prompt">
  ...
  s(45, "STAMP — five checks before anything leaves the building", () => (
    <L.Body kicker="Slide Slide 48 · Guardrails" title="STAMP — five checks before anything leaves the building">
      <StampAccordion />
    </L.Body>
  )),
  ...
  s(47, "Live exercise — apply STAMP", () => (
    <L.Body kicker="Slide Slide 50 · Interactive" title="Live exercise — apply STAMP">
      <StampExercise />
    </L.Body>
  )),
