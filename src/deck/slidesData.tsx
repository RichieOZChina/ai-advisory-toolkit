...
export const SECTIONS: Section[] = [
  ...
  { id: "stamp", title: "STAMP Guardrails", startSlide: 44, color: "#f43f5e" },
  { id: "morning-close", title: "Morning Close", startSlide: 47, color: "#22c55e" },
  { id: "afternoon", title: "Afternoon Build Labs", startSlide: 51, color: "#0ea5e9" },
];
...
export const SLIDES: Slide[] = [
  ...
  s(22, "Why this matters to bankers now", () => (
  ...
  s(23, "The old workflow vs the new workflow", () => (
    <L.Body kicker="Before / after" title="The old workflow vs the new workflow">
      <WorkflowTimeline />
    </L.Body>
  )),

  s(24, "The three things that affect every real task", () => (
  ...
  s(25, "What this session will not teach you", () => (
  ...
  s(26, "Module 3 — How to write a prompt", () => (
...
- If a figure isn't in the source, say "not stated" rather than estimate.`}
  ...
  s(35, "Five things you can do with AI by Monday", () => (
  ...
  s(36, "Move 1 — First draft in two minutes", () => (
  ...
  s(37, "Move 2 — Research without the forty tabs", () => (
  ...
  s(38, "Move 3 — Meeting to action list", () => (
  ...
  s(39, "Move 4 — Compare before you sign", () => (
  ...
  s(40, "Move 5 — Draft while you talk", () => (
  ...
  s(41, "Putting the moves together", () => (
  ...
  s(42, "The rule underneath the rules", () => (
    <L.Center>
  ...
  s(43, "Do not use AI for these three things", () => (
  ...
  s(46, "Live exercise — apply STAMP", () => (
  ...
  s(47, "This morning in one slide", () => (
  ...
  s(48, "What changes this afternoon", () => (
    <L.Center>
      <div className="max-w-4xl text-center">
  ...
  s(49, "One thing you will try this week", () => (
  ...
  s(52, "The strongest starter asset", () => (
  ...
  s(54, "Turn a manual instruction into a controlled workflow", () => (
  ...
  s(55, "Test on a clean case and a difficult case", () => (
  ...
  s(56, "Peer review — controls before elegance", () => (
  ...
  s(64, "Every claim needs a locator and a date", () => (
  ...
  s(65, "A pitch and an IM answer different questions", () => (
  ...
  s(66, "Start with the decision the page must enable", () => (
  ...
  s(67, "A supported headline beats a topic label", () => (
  ...
  s(68, "Separate facts, claims, calculations, inferences, conflicts", () => (
  ...
  s(69, "Encode approved formatting as explicit rules", () => (
  ...
  s(70, "Exercise — build a four-page excerpt and its reusable creator", () => (
  ...
  s(71, "First create the source index and page plan", () => (
  ...
  s(72, "Generate an editable first pass with evidence tags", () => (
  ...
  s(73, "Complete only after evidence and format review", () => (
  ...
  // ---- Lab 3 ----
  s(74, "Research is a traceable chain", () => (
  ...
  s(75, "Three workflows share the same discipline", () => (
  ...
  s(76, "Buyer screening — thesis + explicit exclusions", () => (
  ...
  s(77, "A scoring model organises judgement", () => (
  ...
  s(78, "Sector research — questions before search", () => (
  ...
  s(79, "PE portfolio mapping — current ownership evidence", () => (
  ...
  s(80, "Source ladder + access dates", () => (
  ...
  s(81, "One evidence ledger makes uncertainty visible", () => (
  ...
  s(82, "Exercise — build a defensible first-pass buyer screen", () => (
  ...
  s(83, "Challenge the top candidate", () => (
  ...
  s(84, "A usable screen shows rationale, evidence, and a review trail", () => (
  ...
  // ---- Virtual employee ----
  s(85, "A virtual employee is a controlled workflow", () => (
  ...
  s(86, "One synthetic request end to end", () => (
  ...
  s(87, "Human approval before every consequential action", () => (
  ...
  s(88, "Capability depends on integration, permissions, exception handling", () => (
  ...
  s(89, "Start with one measured, reversible pilot", () => (
  ...
  // ---- Close ----
  s(90, "Five repeatable moves reduce rework", () => (
  ...
  s(91, "Your workshop outputs form a starter operating system", () => (
  ...
  s(92, "Choose one live workflow, clear owner, safe boundary", () => (
  ...
  s(93, "Exercise — write and stress-test your 30-day commitment", () => (
